...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/proxy-image-server
```

A live public deployment of this template is available at [https://proxy-image-server.templates.workers.dev](https://proxy-image-server.templates.workers.dev)
